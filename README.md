...
- **Multi-Mode Learning**:
  ...
  - ❓ **/quiz `<topic>`**: Generates exactly 5 multiple-choice questions with answers hidden.
...
1. Import [ai_study_assistant_workflow.json](ai_study_assistant_workflow.json) to your n8n instance.
2. Link your **Telegram Bot Token** to the Telegram nodes.
3. Configure the **Call Claude API** node's HTTP Header Auth:
